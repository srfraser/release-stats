...
plotly.offline.plot(go.Figure(data=all_data, layout=layout), filename='task-runtimes.html')
plotly.offline.plot(go.Figure(data=some_data, layout=layout), filename='task-runtimes-filtered.html')
